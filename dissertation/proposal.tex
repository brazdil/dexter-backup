...
i.e. code outside paths between sources and sinks. 
...
The downside of this solution is that the propagation rules must be
...
\item Application must pass APKs to apktool in order to extract its
      content, and to repackage them after instrumentation.
...
\begin{itemize}
    ...
    \item{\textbf{Fortnight 1 (\nicefrac{2}{2} October 2012)}: \\
          Process a DEX file, analyse its content, save the content to another
          file.}
