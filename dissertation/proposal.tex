...
\footnote[1]{www.idc.com/getdoc.jsp?containerId=prUS23638712}
...
One such approach is shown in TaintDroid \footnote[2]{www.appanalysis.org}, 
...
of the work will be done on my personal computer (Asus UL20A laptop, 
Intel Core 2 Duo 1.3GHz CPU, 4GB RAM, 320GB HDD). I accept full 
responsibility for this machine and I have made contingency 
...
Android Malware Genome Project \footnote[3]{www.malgenomeproject.org}. 
Sufficient disc allocation of 3GB will be needed on the PWF to store
a snapshot of the repository. 

An Android smartphone will be supplied by Dr Alastair Beresford 
(arb33@cam.ac.uk) to test the project on. In case of problems, the Android 
emulator can be used instead.
