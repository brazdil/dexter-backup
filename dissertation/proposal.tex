...
used to test the internal of the instrumenting application, and shell 
scripts will be created that will try to execute small snippets of 
instrumented code on an actual Dalvik virtual machine, be it on a proper 
device or in the provided emulator.
