...
public class DexInstruction_ConvertToWide extends DexInstruction {
  ...
  public DexInstruction_ConvertToWide(DexCode methodCode, Instruction insn, CodeParserState parsingState) throws InstructionParseError {
    super(methodCode);
  ...
  public String toString() {
    return insnOpcode.getAssemblyName() + " " + regTo1.toString()
           + "|" + regTo2.toString()
           + ", " + regFrom.toString();
  }
