...
public class DexInstruction_ConvertWide extends DexInstruction {
  ...
  public DexInstruction_ConvertWide(DexRegister to1, DexRegister to2, DexRegister from1, DexRegister from2, Opcode_ConvertWide opcode) {
    RegTo1 = to1;
    RegTo2 = to2;
    RegFrom1 = from1;
    RegFrom2 = from2;
  ...
  public DexInstruction_ConvertWide(Instruction insn, DexCode_ParsingState parsingState) throws InstructionParsingException {
