...
public class DexInstruction_InstancePutWide extends DexInstruction {
  ...
  public DexInstruction_InstancePutWide(DexCode methodCode, Instruction insn, CodeParserState parsingState) throws InstructionParseError, UnknownTypeException {
    super(methodCode);
