...
public class DexInstruction_NewInstance extends DexInstruction {
  ...
  @Getter private final DexType_Class value;

  public DexInstruction_NewInstance(DexCode methodCode, DexRegister to, DexType_Class value) {
    super(methodCode);
