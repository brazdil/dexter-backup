...
public class DexInstruction_StaticGet extends DexInstruction {
  ...
  public DexInstruction_StaticGet(DexCode methodCode, DexRegister to, DexType_Class fieldClass, DexType_Register fieldType, String fieldName, Opcode_GetPut opcode) {
    super(methodCode);
